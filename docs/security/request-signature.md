...
const app = createServer({
    security: {
        requestSignature: {
            ...
            secret:
                __xhsc__.__env__.get("SIG_SECRET", "your-32-character-minimum-secret-here"),
...
3. **Environment Management**: Use `__xhsc__.__env__.get()` to access environment variables. Avoid direct access to `process.env` to maintain compatibility with the XyPriss security model.
