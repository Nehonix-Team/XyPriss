...
import { XyPrissPlugin, PluginServer } from "../../types/PluginTypes";
    ...
    implements XyPrissPlugin
{
    ...
    public type = "ops";
    public description =
        "Automatic server health monitoring and background maintenance";
    ...
    /**
     * Hook for modern XyPriss Plugin System
     */
    public onServerStart(server: PluginServer): void {
