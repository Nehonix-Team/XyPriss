...
This test project is used for XFPM Go Edition testing purpose
...
The server will start on `http://localhost:8080` with hot reload and TypeScript compilation enabled.
