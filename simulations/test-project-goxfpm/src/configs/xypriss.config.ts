...
export const serverConfig: ServerOptions = {
  ...
  server: {
     ...
     * High-security, low-latency encrypted session management.
     */
    xems: {
      enabled: true, // Recommended: Always enable XEMS for secure sessions
      sessionTtl: 3600, // 1 hour session lifetime
      rotationInterval: 600, // Rotate encryption keys every 10 minutes
      gracePeriod: 10000, // 10s grace period during rotation
      persistence: {
        enabled: false, // Set to true to persist sessions across restarts
        secret: "", // IMPORTANT: Set a 32-byte secret for production!
        path: "./.private/xvault.xems",
      },
    },
  },
